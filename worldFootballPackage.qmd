...
```
```{r}
# Create the ggplot with thicker lines and ensure small counts are visible
p <- ggplot(filtered_df, aes(x = injured_since, color = club)) +
  geom_line(stat = "count", size = 1) +  # Thicker line
  geom_point(stat = "count", size = 1) +  # Add points for visibility of smaller counts
